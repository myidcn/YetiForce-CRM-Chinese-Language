...
$languageStrings = [
	...
	'LBL_RC_smtp_user' => '登录到 SMTP 服务器 ("%u"-用户的登录名)',
	...
	'LBL_RC_skin_logo' => '徽标',
	'LBL_RC_ip_check' => '给予授权同时检查客户端IP地址',
	'LBL_RC_enable_spellcheck' => '拼写检查模块',
	'LBL_RC_identities_level' => '访问级别',
	'LBL_RC_auto_create_user' => '在登录时自动创建新用户',
	'LBL_RC_smtp_log' => '保存已发送邮件日志',
	'LBL_RC_mail_pagesize' => '列表视图中的邮件数',
	'LBL_RC_addressbook_pagesize' => '在列表视图中的联系人数量',
	'LBL_RC_prefer_html' => '以html格式显示消息',
	'LBL_RC_preview_pane' => '如果激活预览窗格',
	'LBL_RC_htmleditor' => '在HTML格式的邮件',
	'LBL_RC_draft_autosave' => '自动保存创建的消息每:（秒）',
	'LBL_RC_mdn_requests' => '如果消息要求交货通知要如何动作',
	'LBL_RC_session_lifetime' => '会话的生存期的分钟数',
	'LBL_RC_sendmail_delay' => '发送消息时的延迟时间',
	'LBL_RC_date_long' => '日期格式',
	'LBL_RC_validate_cert' => '验证证书',
	'LBL_RC_imap_open_add_connection_type' => '地址中添加类型和协议',
	'identities_level_0' => '编辑所有参数的很多识别证',
	'identities_level_1' => '编辑所有参数（不包含邮件地址）的很多识别证',
	'identities_level_2' => '一个负责',
	'identities_level_3' => '一个身份与编辑所有的参数，但不是电子邮件地址的可能性',
	'identities_level_4' => '一个身份与编辑只有签名的可能性',
	'htmleditor_0' => '从不',
	'htmleditor_1' => '总是',
	...
	'mdn_requests_1' => '自动发送',
	'mdn_requests_2' => '忽略',
	'mdn_requests_3' => '自动发送如果发件人在通讯簿中，否则询问用户',
	'mdn_requests_4' => '发送自动如果发件人在通讯簿中，否则忽略',
	'LBL_SAVE' => '保存配置',
	'Mails List' => '最新的电子邮件',
	...
	'LBL_ADD_HELPDESK' => '添加票证',
	'LBL_ADD_PRODUCTS' => '添加产品',
	'LBL_ADD_SERVICES' => '添加服务',
	'LBL_SEND_MASS_EMAIL' => '发送大量的电子邮件',
	'LBL_NUMBER_OF_FOUND_MAIL_ADDRESSES' => '查找到邮件地址数量',
	'LBL_NUMBER_OF_SELECTED_RECORDS' => '所选的数量',
	'LBL_MINIMIZE_BAR' => '最小化工具条',
];
$jsLanguageStrings = [
	'NoFindEmailInRecord' => '记录没有电子邮件地址',
	'AddFindEmailInRecord' => '下载的电子邮件',
	'StartedDownloadingEmail' => '开始下载电子邮件',
];
