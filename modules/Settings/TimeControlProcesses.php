 ...
 * *********************************************************************************************************************************** */
$languageStrings = [
	'LBL_TIMECONTROL_PROCESSES' => '工作流',
	'LBL_TIMECONTROL_PROCESSES_DESCRIPTION' => ' ',
	'LBL_ONEDAY_VALID' => '限于 24 小时的工作时间',
	'LBL_TIMEOVERLAP_VALID' => '允许时间重叠',
	'LBL_GENERAL_SETTINGS' => '常规设置',
	'TimeControlProcesses' => '时间控制流程',
	'LBL_TIME_CONTROL_WIDGET' => '时间控制部件',
	'LBL_TCW_INFO' => '这里可找到。隐藏/显示时间控制部件图标的选项.',
	'LBL_HOLIDAYS' => '节日图标',
	'LBL_WORKING_DAYS' => '工作日的图标',
	'LBL_WORKING_TIME' => '工作时间图标',
];
